...
The system is based on open source software. It is running XXXXXX, a Debian based GNU/Linux operating system. The version on the device is outdated and not supported any more. The references package repositories are not available any more, making it impossible to update or install additional packages.
